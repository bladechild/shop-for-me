...
export default function FirstSectionProfileTalent() {
    ...
    const getData = ({ target }) => {
        if (target.files[0]) {
            const uploadStep = storage
                .ref(`images/${target.files[0].name}`)
                .put(target.files[0]);
            uploadStep.on(
                'state_changed',
                snapshot => {
    ...
    const UpdateEditprofileTitleOverView = () => {
        ...
        push(`/profile/${id}`, {replace: true});
    };
    const UpdateEditPortofolio = () => {
        if (imageItself !== '' && imgTitle !== '') {
            let arr3 = [
                ...portfolioList,
                { image: imgUrl, imagetitle: imgTitle },
            ];
                    ...
                    {lang === "ar" ? user?.availability
                      ...
                      : "not available for 3 months"}
                                    ...
                                    <p>
                                        ...
                                        {lang === 'ar'
                                            ? user.englishProficiencyAr
                                            : user.englishProficiency}
                                    </p>
                                    {user?.otherLanguages?.map(langItem => (
                                        <p>
                                            {lang === 'ar'
                                                ? [
                                                      langItem.languageAr,
                                    ...
                                    <h5 className='fw-bold mt-3 text-muted'>
                                        {t('Education')}
                                    </h5>
                                    <p>
                                        <span className='text-muted'>
                                ...
                                <div className='col-6 px-4'>
                                    ...
                                    <div className='row'>
                                        <h3 className='col mx-0 text-muted'>
                                            {t('Work History')}
                                        </h3>
                                        {!clientRoute && (
                                            <button
                                    ...
                                    <div className='bg-white py-lg-1 row py-xs-5'>
                                        <div className='col-10 py-3'>
                                            <a className='advanced-search-link fw-bold'>
                                                I'm looking for video, carousel
                                                and image advertising creation
                                                with branding to make facebook
                                                ads
                                            </a>
                                            <p className='my-3'>
                                                <svg
                                        ...
                                        <hr />
                                        <div className='row'>
                                            <h3 className='col-4 mx-0 text-muted'>
                                                {t('Portfolio')}
                                            </h3>
                                            {!clientRoute && (
                                                <button
